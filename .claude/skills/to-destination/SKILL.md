...
Compact is the point — a fresh agent should read the whole thing and be oriented. Favour the sentence over the section, and let existing artifacts carry their own weight: reference a spec, ADR, commit, or file by path rather than restating it.
