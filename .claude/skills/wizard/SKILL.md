...
The division of labour is fixed: the human does every step inside a third-party account, and the wizard only opens the page, says what to do, and writes down what the human captured. It never signs in, clicks, or pays on the human's behalf — that is the point of it, not a limitation.
